...
function App() {
  ...
  const Logo = () => (
    ...
    >
      ...
      >
        <img src="/assets/logo.png" alt="ShoverHub logo" className="w-full h-full object-cover" />
      </div>
    </div>
  );
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="mt-10 text-left max-w-3xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <a href="/app-development" className="rounded-lg px-4 py-3 transition-colors hover:opacity-90" style={{ backgroundColor: themeTokens.colors.surface, border: `1px solid ${themeTokens.colors.border}`, color: themeTokens.colors.text }}>
                    App Development Services
                  </a>
                  <a href="/website-development" className="rounded-lg px-4 py-3 transition-colors hover:opacity-90" style={{ backgroundColor: themeTokens.colors.surface, border: `1px solid ${themeTokens.colors.border}`, color: themeTokens.colors.text }}>
                    Website Development Services
                  </a>
                  <a href="/product-design" className="rounded-lg px-4 py-3 transition-colors hover:opacity-90" style={{ backgroundColor: themeTokens.colors.surface, border: `1px solid ${themeTokens.colors.border}`, color: themeTokens.colors.text }}>
                    Product Design Services
                  </a>
                  <a href="/hostel-management-software" className="rounded-lg px-4 py-3 transition-colors hover:opacity-90" style={{ backgroundColor: themeTokens.colors.surface, border: `1px solid ${themeTokens.colors.border}`, color: themeTokens.colors.text }}>
                    Hostel Management Software
                  </a>
                  <a href="/digital-invitation-platform" className="rounded-lg px-4 py-3 transition-colors hover:opacity-90 sm:col-span-2" style={{ backgroundColor: themeTokens.colors.surface, border: `1px solid ${themeTokens.colors.border}`, color: themeTokens.colors.text }}>
